...
app = FastAPI(title="ASTORIE Business Risk Hub", version="3.0.3")
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
    allow_methods=["*"],
...
def health():
    ...
    try:
        ...
        ok = False
    return {"ok": True, "database_connected": ok, "version": "3.0.3", "name": "Business Risk Hub 3.0.3 - Insurance Card Admin Textation Restore"}
