...
app = FastAPI(title="ASTORIE Business Risk Hub", version="3.3.0")
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
    allow_methods=["*"],
...
def health():
    ...
    try:
        ...
        ok = False
    return {"ok": True, "database_connected": ok, "version": "3.3.0", "name": "Business Risk Hub 3.3.0 - Smart Nabídky & Textation Workflow PRO"}
